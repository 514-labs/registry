...
This guide walks you through implementing your `klaviyo` connector from scaffold to production.
...
- [ ] Read the `klaviyo` API documentation
...
- [ ] Define resource types in `src/resources/profiles.ts`
