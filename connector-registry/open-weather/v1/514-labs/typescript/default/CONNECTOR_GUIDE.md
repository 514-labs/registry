...
This guide walks you through implementing your `open-weather` connector from scaffold to production.
...
- [ ] Read the `open-weather` API documentation
...
- [ ] Define resource types in `src/resources/current-weather.ts`
