...
import { createResource as createDefaultResource } from '../resources/data'
...
export class Connector extends ApiConnectorBase {
  initialize(userConfig: ConnectorConfig) {
    const withDefaults = (u: ConnectorConfig): ConnectorConfig => ({ userAgent: u.userAgent ?? 'this-is-a-test', ...u })
  ...
  get data() { return createDefaultResource(this.sendLite as any) }
}
