...
This guide walks you through implementing your `ads-b-dot-lol` connector from scaffold to production.
...
- [ ] Read the `ads-b-dot-lol` API documentation
...
- [ ] Define resource types in `src/resources/aircraft.ts`
