...
3. **Example connectors**: Reference existing connectors in the registry for patterns
   ...
   - SaaS Connectors: [Google Analytics](/registry/google-analytics/v4/fiveonefour/typescript/README.md), [Shopify](/registry/shopify/v2025-01/fiveonefour/typescript/README.md)
...
Open a pull request to the [connector-factory repository](https://github.com/514-labs/connector-factory) to share your connector with the community. Mention the connector [Issue](https://github.com/514-labs/connector-factory/issues) in the PR description.
