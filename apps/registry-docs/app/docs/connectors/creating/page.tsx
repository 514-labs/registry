...
cd factory`}</code>
      ...
      <pre>
        <code>{`bash -i <(curl https://connectors.514.ai/install.sh) [connector-name] [version] [author] [language]`}</code>
      </pre>
      ...
      <pre>
        <code>{`bash -i <(curl https://connectors.514.ai/install.sh) ads-b-dot-lol v2 fiveonefour typescript`}</code>
      </pre>
