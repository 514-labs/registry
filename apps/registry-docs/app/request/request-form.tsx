...
interface RequestConnectorFormProps {
  type: "connector" | "pipeline";
}

export function RequestConnectorForm({ type }: RequestConnectorFormProps) {
  ...
  const DRAFT_KEY = `${type}-request-draft`;
      ...
      <CardContent className="space-y-4 pt-6">
        ...
        <div className="grid gap-2">
          <Label htmlFor="category">
            {type === "connector" ? "Connector type" : "Pipeline type"}
          </Label>
          <Select
            ...
            <SelectContent>
              {type === "connector" ? (
                ...
                <>
                  ...
                  <SelectItem value="reverse-etl">Reverse ETL</SelectItem>
