...
// Use __dirname to ensure we write to the correct apps/registry-docs/public directory
const outputPath = join(__dirname, "..", "public", "registry-contents.json");
writeFileSync(outputPath, JSON.stringify(response, null, 2));

console.log(`✓ Generated registry data: ${response.total} total items (${response.connectors} connectors, ${response.pipelines} pipelines)`);
