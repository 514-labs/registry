...
**Example:**
```bash
bash -i <(curl https://registry.514.ai/install.sh) --type connector ads-b-dot-lol v2 fiveonefour typescript
```
...
**Example:**
```bash
bash -i <(curl https://registry.514.ai/install.sh) --type pipeline google-analytics-to-clickhouse v1 fiveonefour typescript
```
